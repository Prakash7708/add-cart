...
function Home() {
   ...
   let handleAddtoCart = (id) =>{
    ...
    dataUpdate.setCartItems([...dataUpdate.cartitems,newcart])
    
    dataUpdate.setTotal(dataUpdate.total+1)
   }
  ...
  {/* Product image*/}
     {
      ...
      carts.map((input)=>{
        ...
        return <Cart addcart={dataUpdate.cartitems} data={input} handleAddtoCart={handleAddtoCart}/>
      })
     }
